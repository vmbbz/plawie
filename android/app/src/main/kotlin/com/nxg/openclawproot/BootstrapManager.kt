...
""".trimIndent()
        ...
        // 4.1. Network Shim - fixes uv_interface_addresses EACCES 13 on Android 11+
        // This is more comprehensive than hijack.js and matches the recommended fix.
        val networkShimContent = """
        ...
        """.trimIndent()
        File(bypassDir, "network-shim.js").writeText(networkShimContent)
