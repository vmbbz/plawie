...
| Current debug refresh / SHA-256 | Built, package metadata verified, and APK credential audit passed | `8EB38114FB0EF28FE6A4DF813D866840D7CD8B8AD0387B7994E1509D2904FC39` | version `2.3.0` (`14`); release `v2.3.0-hackathon-preview.3`; debug test artifact, not the Play-signed production build |
