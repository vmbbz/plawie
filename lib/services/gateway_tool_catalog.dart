class GatewayToolCatalog {
  ...
  static const mobileNodeAllowCommands = <String>[
    ...
    'payments_send_eth',
    'payments_send_usdg',
    'base-chain.set_policy',
    'base-chain.get_policy',
    'base-chain.send_usdc',
    'base-chain.send_eth',
    'base-chain.send_usdg',
    'base-chain.get_balance',
    'base-chain.resolve_basename',
    'base_chain_set_policy',
    'base_chain_get_policy',
    'base_chain_send_usdc',
    'base_chain_send_eth',
    'base_chain_send_usdg',
    'base_chain_get_balance',
    'base_chain_resolve_basename',
