...
For OpenClaw phone, hardware, sensor, camera, canvas, weather, ClawHub metadata, location, screen, haptic, flashlight, or avatar gesture actions, call the OpenClaw nodes tool with "node": "$nodeHandle".
