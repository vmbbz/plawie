    ...
    try {
      ...
      if (code != null) {
        ...
        if (isLocal) {
          ...
          try {
            await NativeBridge.runInProot('export NODE_OPTIONS="--require /root/.openclaw/bionic-bypass.js --require /root/.openclaw/network-shim.js" && openclaw nodes approve $code');
